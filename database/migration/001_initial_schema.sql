...
-- AppMass database initialization
-- ============================================================

BEGIN;

-- --------------------------------------------------
-- Profiles (extends Appwrite Users)
-- --------------------------------------------------
...
-- Posts
-- --------------------------------------------------
CREATE TYPE IF NOT EXISTS post_type AS ENUM ('text', 'image', 'video', 'poll');
...
-- Ad Campaigns
-- --------------------------------------------------
CREATE TYPE IF NOT EXISTS campaign_status AS ENUM ('draft', 'active', 'paused', 'ended');
